...
import { menuContentMock } from "../../mock/menu-content-mock";
...
export const Template: Story = {
	...
	render: (args) => (
		...
		>
			...
			<p>
				Mauris ipsum. <b>Curabitur sodales ligula in libero</b>. Nulla
				...
				<b>Maecenas mattis</b>. Nam nec ante. Sed lacinia, urna non
				tincidunt mattis, tortor neque adipiscing diam, a cursus ipsum
				ante quis turpis. Nulla facilisi.{" "}
				<b>Proin ut ligula vel nunc egestas porttitor</b>. Ut fringilla.
			...
			<p>
				...
				eget diam. <b>Ut fringilla</b>. Vestibulum ante ipsum primis in
				...
				. Sed non quam. In vel mi sit amet augue congue elementum. Morbi
				in ipsum sit amet pede facilisis laoreet. Donec lacus nunc,
			...
			<p>
				...
				. Nulla facilisi. Integer lacinia sollicitudin massa. Cras
				...
				<b>Morbi in dui quis est pulvinar ullamcorper</b>. Quisque nisl
